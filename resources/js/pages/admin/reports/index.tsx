...
import { ArrowRight, Boxes, ShieldCheck, Wallet, Wrench, type LucideIcon } from 'lucide-react';
            ...
            <div className="flex flex-1 flex-col gap-8 p-4 md:p-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 max-w-2xl">
                        {reportCount} reports grouped by the question they answer. Every report can be filtered, charted, printed, and exported to
                        Excel, CSV, or PDF.
                    </p>
                </div>

                {groups.map((group) => {
                    const Icon = groupIcons[group.key] ?? Boxes;
