        ...
        return (
            <Comp
                ...
                className={cn(
                    ...
                    /*
                  Collapsed, the label is pulled up by exactly its own height so the group closes
                  over it. That lands it on top of the last item of the group before it, where —
                  invisible but still hit-testable — it swallowed that item's clicks. It has to
                  stop taking the pointer as well as the eye.
                */
