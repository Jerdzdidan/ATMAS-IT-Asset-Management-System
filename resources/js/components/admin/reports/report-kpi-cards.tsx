            ...
            {kpis.map((kpi) => (
                <Card key={kpi.label} className="min-w-0">
                    <CardContent className="p-4">
                            ...
                            {kpi.hint && (
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <button type="button" aria-label={`What ${kpi.label} means`} className="shrink-0 cursor-help print:hidden">
                        ...
                        <p className="text-primary mt-1.5 truncate text-2xl font-semibold tabular-nums">{kpi.value}</p>
                    </CardContent>
                </Card>
            ))}
        </div>
